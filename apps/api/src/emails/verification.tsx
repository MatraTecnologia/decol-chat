...
export async function renderVerificationEmail(
  ...
  return await render(
    <Html>
      <Head />
      <Preview>{t.verification.preview}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Heading style={h1}>{t.verification.heading}</Heading>

          <Text style={text}>
            {t.greeting(firstName)} {t.verification.body}
          </Text>
          ...
          <Text style={textMuted}>{t.verification.ignore}</Text>
