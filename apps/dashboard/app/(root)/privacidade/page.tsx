...
const PrivacyPage = () => {
  return (
    <LegalPage title="Política de Privacidade" updatedAt="3 de agosto de 2026">
      ...
      <LegalSection title="2. A que esta política se aplica">
        <p>
          A plataforma centraliza o atendimento de uma empresa aos seus clientes
          pelo WhatsApp. Existem duas categorias de pessoas cujos dados são
          tratados, com papéis distintos:
        </p>
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            esses dados, a empresa contratante atua como controladora e a Matra
            Tecnologia como operadora, tratando os dados conforme as instruções
            dela.
          </li>
        </ul>
      </LegalSection>

      <LegalSection title="3. Dados que tratamos">
        <p>
          ...
          auditoria contendo endereço IP e identificação do navegador. Quando a
          verificação em duas etapas está ativa, também guardamos os segredos
          necessários para validá-la.
        </p>
        <p>
          ...
          figurinhas), data e hora, status de envio, entrega e leitura, além de
          anotações e informações complementares que a equipe de atendimento
          registrar.
        </p>
        <p>
          Guardamos também o registro técnico bruto que a Meta nos envia a cada
          evento. Ele é necessário para investigar falhas de entrega e
      ...
      <LegalSection title="4. Integração com o WhatsApp e uso simultâneo no celular">
        <p>
          A plataforma se conecta ao número da empresa por meio da API oficial
          do WhatsApp Business, fornecida pela Meta. A conexão é autorizada pelo
          próprio responsável da empresa através do fluxo de cadastro da Meta —
          em nenhum momento pedimos a senha da conta de WhatsApp.
        </p>
        <p>
      ...
      <LegalSection title="5. Por que tratamos esses dados">
        <p>
        ...
        <p>
          Registros de acesso, auditoria e segurança são mantidos com fundamento
          no legítimo interesse de proteger a plataforma contra uso indevido e
          de investigar incidentes, e no cumprimento de obrigação legal de
          guarda de registros de aplicação.
        </p>
        <p>
      ...
      <LegalSection title="6. Com quem os dados são compartilhados">
        <p>
          Utilizamos prestadores de serviço que atuam como operadores, apenas no
      ...
      <LegalSection title="7. Segurança e prazo de guarda">
        <p>
          As credenciais de integração são armazenadas cifradas. O acesso ao
          painel exige autenticação, com suporte a verificação em duas etapas, e
          a comunicação trafega por canal criptografado. As requisições
      ...
      <LegalSection title="8. Direitos de quem tem os dados tratados">
        <p>
      ...
      <LegalSection title="9. Cookies">
        <p>
          ...
          escolhido. Não usamos cookies de publicidade nem de rastreamento entre
          sites.
        </p>
      </LegalSection>
      ...
      <LegalSection title="10. Transferência internacional">
        <p>
          ...
          casos, a transferência ocorre com as garantias previstas na legislação
          aplicável, por meio de cláusulas contratuais firmadas com cada
          fornecedor.
        </p>
      </LegalSection>
      ...
      <LegalSection title="11. Menores de idade">
        <p>
          A plataforma é destinada ao uso profissional e não se dirige a menores
          de dezoito anos. Não coletamos intencionalmente dados de crianças e
          adolescentes.
        </p>
      </LegalSection>

      <LegalSection title="12. Mudanças nesta política">
        <p>
